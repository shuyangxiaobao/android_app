...
import com.example.xiaobao.xiaobaokotlin.home15.day1.home15_day1_activity

import java.util.ArrayList


class home15_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home15_MainActivity, home15_day1_activity::class.java)
                this@home15_MainActivity.startActivity(intent)
            }
