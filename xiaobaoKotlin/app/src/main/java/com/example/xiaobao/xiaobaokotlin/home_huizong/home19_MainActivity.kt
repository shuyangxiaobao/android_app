...
import com.example.xiaobao.xiaobaokotlin.home19.day1.home19_day1_activity

import java.util.ArrayList


class home19_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home19_MainActivity, home19_day1_activity::class.java)
                this@home19_MainActivity.startActivity(intent)
            }
