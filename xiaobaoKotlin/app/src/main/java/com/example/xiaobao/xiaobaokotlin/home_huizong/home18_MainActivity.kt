...
import com.example.xiaobao.xiaobaokotlin.home18.day1.home18_day1_activity

import java.util.ArrayList


class home18_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home18_MainActivity, home18_day1_activity::class.java)
                this@home18_MainActivity.startActivity(intent)
            }
