...
import com.example.xiaobao.xiaobaokotlin.home10.day1.home10_day1_activity

import java.util.ArrayList


class home10_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home10_MainActivity, home10_day1_activity::class.java)
                this@home10_MainActivity.startActivity(intent)
            }
