...
import com.example.xiaobao.xiaobaokotlin.home20.day1.home20_day1_activity

import java.util.ArrayList


class home20_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home20_MainActivity, home20_day1_activity::class.java)
                this@home20_MainActivity.startActivity(intent)
            }
