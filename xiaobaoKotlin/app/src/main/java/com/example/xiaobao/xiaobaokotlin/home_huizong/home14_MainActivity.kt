...
import com.example.xiaobao.xiaobaokotlin.home14.day1.home14_day1_activity

import java.util.ArrayList


class home14_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i + 1) {
            1 -> {
                val intent = Intent(this@home14_MainActivity, home14_day1_activity::class.java)
                this@home14_MainActivity.startActivity(intent)
            }
