...
import com.example.xiaobao.xiaobaokotlin.home9.day1.home9_day1_activity1

import java.util.ArrayList


class home9_MainActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        when (i) {
            0 -> {
                val intent = Intent(this@home9_MainActivity, home9_day1_activity1::class.java)
                this@home9_MainActivity.startActivity(intent)
            }
