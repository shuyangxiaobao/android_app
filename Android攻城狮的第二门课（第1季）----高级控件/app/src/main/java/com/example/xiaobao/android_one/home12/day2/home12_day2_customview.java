package com.example.xiaobao.android_one.home12.day2;
...
//  https://blog.csdn.net/weixin_41729259/article/details/88344177
//  https://blog.csdn.net/weixin_41729259/article/details/88344177
public class home12_day2_customview extends View {
    private Context mContext;
    //定义一个paint
    private Paint mPaint;
    private float Kscreenwidth = 1000;

    public home12_day2_customview(Context context) {
        this(context, null);
    }

    public home12_day2_customview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public home12_day2_customview(Context context, AttributeSet attrs, int defStyleAttr) {
