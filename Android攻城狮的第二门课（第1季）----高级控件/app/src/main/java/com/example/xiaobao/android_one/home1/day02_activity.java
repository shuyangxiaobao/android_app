package com.example.xiaobao.android_one.home1;
...
public class day02_activity extends AppCompatActivity implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    private Button btn;
